...
https://www.scaler.com/topics/images/sin-curve1.webp![image](https://github.com/yujinp0/yujinp0.github.io/assets/138744622/646e9d32-0fd3-4a04-b720-50538f71abbc){: .align-center}
...
![image](https://github.com/yujinp0/yujinp0.github.io/assets/138744622/5a2eb4df-1d91-45c6-bdf8-9c50d2abe65c){: width="80%" height="80%"}
...
아래와 같이 padding이 필요한 영역에 -inf값을 더해준다. 해당 영역은 SoftMax 연산을 거치며, 0의 값을 지니게 된다. 
...
2) Decoder의 첫 번째 sub-layer(look a head): 해당 순서 이후의 단어는 고려하지 않기 위하여 사용한다.
   
3) Decoder의 두 번째 sub-layer(padding): Encoder에서 사용한 것과 마찬가지로 문장의 길이가 다른 것을 맞춰주기 위하여 사용한다.
4) 
### 3.2.4. Positive-wise Feed Forward Network(FFNN)
